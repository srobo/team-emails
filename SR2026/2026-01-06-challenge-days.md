...
If you're interested in attending any of these events, please complete [this form][challenge-signup]. Volunteers may also be around virtually on these days for support, should you not be able to attend any events in person.

Spaces are limited at each event, so be sure to let us know soon. We will be allocating and confirming places for it as we receive applications, so sign up soon to avoid disappointment.
