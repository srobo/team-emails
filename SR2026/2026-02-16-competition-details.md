...
subject: SR2026 Competition Details
---
...
As you are hopefully aware, this year the Competition is being held at the University of Southampton on the weekend of [**Saturday 11th April** and **Sunday 12th April**][competition-event-page].
...
- Make sure there are 2 spare USB ports: 1 for your code, and 1 for our "Competition USB". This Competition USB tells your robot that it's [in a competition match][competition-mode] and which corner it's starting in (and thus populates the [`robot.zone` property][robot-attributes]). You will not be able to compete without this.
